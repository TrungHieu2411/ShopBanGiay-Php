    ...
    <div class="row justify-content-center mx-5 px-5 shadow-lg">
        <div class="col-md-8 my-5 px-4">
            <div class="card border border-2 border-dark shadow-lg">
                <div class="card-header fw-bold bg-danger text-warning">{{ __('Đăng ký') }}</div>
                ...
                <div class="card-body shadow-lg">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" placeholder="Nhập tên" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
