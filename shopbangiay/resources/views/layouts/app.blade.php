...
<body>
    ...
    <nav class="navbar p-3 mb-2 bg-secondary navbar-expand-lg navbar-dark bg-light py-2">
        <div class="container">
            ...
            <h1><a href="{{ route('home.index') }}" class="navbar-brand"><span>Shoe's</span> <i>Store</i></a></h1>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    <a class="nav-link active text-whie" href="{{ route('product.index') }}"><i>Sản phẩm</i></a>

                    <a class="nav-link active text-white" href="{{ route('cart.index') }}"><i>Giỏ hàng </i></a>
                    <a class="nav-link active text-white" href="{{ route('about.index') }}"><i>Giới Thiệu</i></a>
                    <div class="vr bg-black x-2 d-none d-lg-block"></div>
                    @guest
                    <a class="nav-link acitve text-white" href="{{ route('register') }}">Admin</a>
                    @else
        ...
        <div class="footer_agileinfo_w3 mt-5">
            <div class="row mt-3 footer_inner_info_w3ls_agileits">
                <div class="col-md-4 footer-left">
                    <h2><a href="{{ route('home.index') }}"><span>S</span>hoe's Store </a></h2>
                    ...
                    <div class="sign-grds">
                        <div class="col-md-4 sign-gd">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('home.index') }}">About</a></li>
                                <li><a href="{{ route('home.index') }}">Services</a></li>
                                <li><a href="{{ route('home.index') }}">Short Codes</a></li>
