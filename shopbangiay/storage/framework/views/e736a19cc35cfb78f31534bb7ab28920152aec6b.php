...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="<?php echo e(route('admin.product.store')); ?>" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 text-start">
                    <input name="name" value="<?php echo e(old('name')); ?>" type="text" class="form-control form-control-sm" placeholder="Nhập tên giày" id="name">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 text-start">
                    <input name="price" value="<?php echo e(old('price')); ?>" type="number" class="form-control form-control-sm" placeholder="Nhập giá tiền" id="price">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 text-start">
                    <input class="form-control form-control-sm" value="<?php echo e(old('img')); ?>" type="file" name="image" id="image">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 text-start">
                    <input name="size" value="<?php echo e(old('size')); ?>" type="number" class="form-control form-control-sm" placeholder="Nhập kích cỡ" id="size">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 text-start">
                    <input name="trademark" value="<?php echo e(old('trademark')); ?>" type="text" class="form-control form-control-sm" placeholder="Nhập thương hiệu" id="trademark">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 text-start">
                    <input class="form-control form-control-sm" value="<?php echo e(old('typepdt_id')); ?>" type="string" name="typepdt_id" id="typepdt">
                </div>
            </div>
        ...
        <div class="row mb-3">
            <div class="mt-2">
                <a href="<?php echo e(route('admin.typepdt.index')); ?>" class="link-info text-decoration-none"><button class="btn btn-outline-danger form-control form-control-sm">Chuyển sang trang loại sản phẩm</button></a>
            </div>
        </div>
    </div>
</div>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($product->getImage()); ?></td>
                    <td><?php echo e($product->getSize()); ?></td>
                    <td><?php echo e($product->getTrademark()); ?></td>
                    <td><?php echo e($product->getDescription()); ?></td>
                    <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ShopBanGiay-Php\shopbangiay\resources\views/admin/product/index.blade.php ENDPATH**/ ?>