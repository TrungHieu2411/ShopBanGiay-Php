...
<div class="container mt-3 text-center">
    <div class="row">
        <?php $__currentLoopData = $viewData['about']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $about): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-lg-12 ms-auto">
            <div class="col">
                <h4><b>
                        <?php echo e($about ->getName()); ?>

                        <!-- BÁN GIÀY THỂ THAO SNEAKER CHÍNH HÃNG TẠI TP.HCM -->
                    </b></h4>
                <p>
                    <?php echo e($about ->getMainDescription()); ?>
                ...
                <p>
                    <?php echo e($about ->getDescription()); ?>
                ...
                <div class="ratio ratio-16x9">
                    <iframe width="560" height="315" src="<?php echo e($about ->getRatio1()); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
                ...
                <div class="ratio ratio-16x9">
                    <iframe width="560" height="315" src="<?php echo e($about ->getRatio2()); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ShopBanGiay-Php\shopbangiay\resources\views/about/index.blade.php ENDPATH**/ ?>